        ...
        <main class="site-main bg-[#fcf9f5] min-h-screen flex items-center justify-center py-20">
            <div class="max-w-[440px] w-full mx-auto px-6">
                ...
                <div class="mt-8 text-center border-t border-[#e5e2de] pt-8">
                    ...
                    <a href="{{ url('/login') }}" wire:navigate class="inline-block font-mono text-[10px] font-bold tracking-[0.2em] uppercase text-[#1c1c1a] border border-[#1c1c1a] px-8 py-3 hover:bg-[#f0ede9] transition-colors">
                        Log In di Sini
                    </a>
                </div>
