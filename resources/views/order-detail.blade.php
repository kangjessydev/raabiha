    ...
    <div class="page-slide-in">
        <main class="site-main bg-[#fcf9f5] min-h-screen pb-20 md:pb-0">
            <div class="max-w-[800px] mx-auto px-6 py-12 md:py-24">
                ...
                <!-- Back Link (Desktop) -->
                <a href="{{ url('/account') }}" class="hidden md:inline-flex items-center gap-2 font-mono text-[10px] uppercase tracking-widest text-[#615e57] hover:text-[#1c1c1a] transition-colors mb-8">
