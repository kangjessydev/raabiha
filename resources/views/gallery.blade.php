        ...
        <div class="space-y-6 md:space-y-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10">
                ...
                <div class="md:col-span-7 relative group overflow-hidden">
                    <img src="{{ asset('assets/images/gallery-1.png') }}" alt="Model in white" class="w-full h-full object-cover aspect-[3/4] md:aspect-auto group-hover:scale-105 transition-transform duration-700">
                ...
                <div class="md:col-span-5 flex flex-col gap-6 md:gap-10">
                    <div class="w-full h-1/2 overflow-hidden group">
                        <img src="{{ asset('assets/images/gallery-5.png') }}" alt="Green texture" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                    </div>
                    <div class="w-full h-1/2 overflow-hidden group">
                        <img src="{{ asset('assets/images/gallery-3.png') }}" alt="Fabric texture" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                    </div>
                </div>
            </div>
            ...
            <div class="w-full overflow-hidden group">
                <img src="{{ asset('assets/images/gallery-2.png') }}" alt="Interior space" class="w-full h-auto object-cover aspect-[21/9] md:aspect-[3/1] group-hover:scale-105 transition-transform duration-700">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10">
                ...
                <div class="flex flex-col gap-6">
                    <div class="overflow-hidden group h-[85%]">
                        <img src="{{ asset('assets/images/gallery-4.png') }}" alt="Model in black" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                    </div>
                ...
                <div class="overflow-hidden group h-full">
                    <img src="{{ asset('assets/images/about-atelier.png') }}" alt="Wardrobe" class="w-full h-full object-cover aspect-[4/5] md:aspect-auto group-hover:scale-105 transition-transform duration-700">
                </div>
                <!-- Col 3 -->
                <div class="flex flex-col gap-6 md:gap-10 h-full">
                    ...
                    <div class="flex-1 overflow-hidden group">
                        <img src="{{ asset('assets/images/contact-hero.png') }}" alt="Stairs" class="w-full h-full object-cover grayscale opacity-80 group-hover:scale-105 transition-transform duration-700">
                    </div>
                </div>
            </div>
    ...
    <section class="bg-[#fcf9f5] max-w-[1440px] mx-auto px-6 lg:px-12 py-20 md:py-32">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            <div class="order-1 md:order-2 overflow-hidden group">
                <img src="{{ asset('assets/images/about-atelier.png') }}" alt="Textured Jacket" class="w-full h-auto aspect-[3/4] object-cover grayscale opacity-90 group-hover:scale-105 transition-transform duration-700">
            </div>
        </div>
    </section>
