                ...
                <div class="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-12 lg:gap-16 items-start">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="cart-item-row flex flex-row sm:flex-row gap-4 sm:gap-8 pb-6 sm:pb-12 mb-6 sm:mb-12 border-b border-[#e5e2de] sm:border-[rgba(23,24,24,0.1)]">
                            ...
                            <div class="w-[90px] h-[120px] sm:w-[280px] sm:h-[280px] bg-[#f0ede9] shrink-0">
                                <img src="{{ asset('assets/images/gallery-3.png') }}" alt="Placeholder" class="w-full h-full object-cover">
                            </div>
                            <!-- Info -->
                            <div class="flex flex-col flex-1 py-0 sm:py-2 min-w-0">
                                <div class="flex flex-col sm:flex-row justify-between items-start gap-1 sm:gap-4 w-full">
                                    <h3 class="font-serif text-base sm:text-[24px] font-semibold text-[#1c1c1a] leading-tight sm:normal-case line-clamp-2 sm:line-clamp-none pr-1">
                                        <a href="/product-detail" class="hover:text-[#615e57] transition-colors">The Asymmetrical Tunic</a>
                                    </h3>
                                ...
                                <div class="flex sm:hidden font-mono text-[10px] uppercase tracking-[0.1em] text-[#615e57] mt-1 mb-auto flex-wrap gap-1 truncate w-full">
                                    Size: M/L <span class="mx-1">/</span> Color: Slate Sand
                                </div>
                                
                                <!-- Desktop Variations -->
                                <div class="hidden sm:block font-mono text-[9px] uppercase tracking-[0.1em] text-[#615e57] mt-2 mb-8">SKU: RBH-ASM-001</div>
                                <div class="hidden sm:grid grid-cols-[80px_1fr] gap-y-4 mb-auto">
                                    ...
                                    <div class="font-sans text-[14px] text-[#1c1c1a] uppercase">M/L</div>
                                    <div class="font-mono text-[10px] font-semibold tracking-[0.1em] text-[#1c1c1a] uppercase">Color</div>
                                    <div class="font-sans text-[14px] text-[#1c1c1a] uppercase">Slate Sand</div>
                                </div>
                                ...
                                <div class="flex justify-between items-center mt-4 sm:mt-8 w-full">
                                    <div class="border border-[#e5e2de] flex items-stretch h-[36px] sm:h-[48px] qty-container">
                                        <button type="button" class="w-10 sm:w-12 h-full flex items-center justify-center text-[#615e57] hover:text-[#1c1c1a] hover:bg-black/5 transition-colors focus:outline-none">
                                        ...
                                        <input type="number" value="1" min="1" class="h-full w-8 sm:w-12 bg-transparent text-center font-mono text-[12px] sm:text-[14px] text-[#1c1c1a] focus:outline-none appearance-none p-0 m-0 border-0" style="-moz-appearance: textfield;">
                                        <button type="button" class="w-10 sm:w-12 h-full flex items-center justify-center text-[#615e57] hover:text-[#1c1c1a] hover:bg-black/5 transition-colors focus:outline-none">
                                    ...
                                    <!-- Mobile Remove Link -->
                                    <a href="#" class="block sm:hidden font-mono text-[10px] font-bold tracking-[0.1em] text-[#ba1a1a] uppercase hover:text-[#1c1c1a] transition-colors">REMOVE</a>
                                    <!-- Desktop Remove Link -->
                                    <a href="#" class="hidden sm:flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.1em] text-[#615e57] hover:text-[#1c1c1a] transition-colors group"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6 18L18 6M6 6l12 12"/></svg><span>Hapus</span></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="cart-item-row flex flex-row sm:flex-row gap-4 sm:gap-8 pb-6 sm:pb-12 mb-6 sm:mb-12 border-b border-[#e5e2de] sm:border-[rgba(23,24,24,0.1)]">
                            <!-- Image -->
                            <div class="w-[90px] h-[120px] sm:w-[280px] sm:h-[280px] bg-[#f0ede9] shrink-0">
                                <img src="{{ asset('assets/images/gallery-5.png') }}" alt="Placeholder" class="w-full h-full object-cover">
                            </div>
                            <!-- Info -->
                            <div class="flex flex-col flex-1 py-0 sm:py-2 min-w-0">
                                <div class="flex flex-col sm:flex-row justify-between items-start gap-1 sm:gap-4 w-full">
                                    <h3 class="font-serif text-base sm:text-[24px] font-semibold text-[#1c1c1a] leading-tight sm:normal-case line-clamp-2 sm:line-clamp-none pr-1">
                                        <a href="/product-detail" class="hover:text-[#615e57] transition-colors">Structured Trousers</a>
                                    </h3>
                                    <div class="item-subtotal-val font-sans text-sm sm:text-[18px] font-medium sm:font-normal text-[#1c1c1a] whitespace-nowrap shrink-0">
                                        Rp650.000
                                    </div>
                                ...
                                <!-- Mobile Variations -->
                                <div class="flex sm:hidden font-mono text-[10px] uppercase tracking-[0.1em] text-[#615e57] mt-1 mb-auto flex-wrap gap-1 truncate w-full">
                                    Size: S <span class="mx-1">/</span> Color: Charcoal
                                </div>
                                
                                <!-- Desktop Variations -->
                                <div class="hidden sm:block font-mono text-[9px] uppercase tracking-[0.1em] text-[#615e57] mt-2 mb-8">SKU: RBH-TRS-002</div>
                                <div class="hidden sm:grid grid-cols-[80px_1fr] gap-y-4 mb-auto">
                                    <div class="font-mono text-[10px] font-semibold tracking-[0.1em] text-[#1c1c1a] uppercase">Size</div>
                                    <div class="font-sans text-[14px] text-[#1c1c1a] uppercase">S</div>
                                    <div class="font-mono text-[10px] font-semibold tracking-[0.1em] text-[#1c1c1a] uppercase">Color</div>
                                    <div class="font-sans text-[14px] text-[#1c1c1a] uppercase">Charcoal</div>
                                </div>
                    ...
                    <div class="bg-transparent lg:bg-[#f0ede9] p-0 lg:p-10 sticky top-[120px]">
                        ...
                        <div class="flex justify-between items-end mb-8 py-6 lg:py-0">
                            ...
                            <span class="font-serif text-[24px] lg:text-[32px] font-semibold text-[#1c1c1a] leading-none">Rp1.500.000</span>
                        </div>
