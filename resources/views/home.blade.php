...
<main class="w-full min-h-screen">
    ...
    <section class="hidden md:grid grid-cols-2 w-full h-[calc(100vh-80px)] bg-[#fcf9f5]">
        ...
        <div class="flex flex-col justify-center px-8 py-10 lg:py-12 lg:pl-24 lg:pr-16 text-left bg-[#fcf9f5]">
            <div class="inline-block bg-[#1c1c1a] text-[#E1DCC9] px-3 py-1 text-[10px] font-semibold tracking-[0.15em] mb-4 uppercase w-fit">{{ $homeHeroTag }}</div>
            ...
            <a href="{{ $homeHeroButtonLink }}" class="inline-block bg-[#1c1c1a] hover:bg-black text-[#E1DCC9] text-[11px] font-semibold tracking-[0.15em] uppercase py-3 px-8 transition-colors w-fit">
                {{ $homeHeroButtonText }}
            </a>
        </div>
    ...
    <section class="relative w-full h-[calc(100vh-64px)] flex items-center justify-center md:hidden overflow-hidden">
        ...
        <div class="relative z-10 w-full px-8 py-6 flex flex-col items-center text-center mt-12">
            <div class="inline-block bg-[#1c1c1a] text-[#E1DCC9] px-3 py-1 text-[9px] font-mono tracking-[0.2em] mb-4 uppercase">{{ $homeHeroTag }}</div>
            <h1 class="text-3xl md:text-4xl leading-[1.15] font-serif italic text-white mb-6">{!! nl2br(e($homeHeroTitle)) !!}</h1>
            <a href="{{ $homeHeroButtonLink }}" class="inline-block bg-[#1c1c1a] text-[#E1DCC9] text-[10px] font-mono tracking-[0.1em] uppercase py-3 px-8 w-full max-w-[280px]">
                {{ $homeHeroButtonText }}
            </a>
        </div>
    </section>
