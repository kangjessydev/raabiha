    ...
    <section class="max-w-[1440px] mx-auto px-6 lg:px-12">
        ...
        @elseif($products->isEmpty() && $posts->isEmpty())
            <div class="text-center py-24 border border-dashed border-[#e5e2de] bg-white/50">
                ...
                <a href="{{ url('/shop') }}" class="inline-block border border-[#1c1c1a] px-6 py-3 text-[10px] font-mono font-bold uppercase tracking-widest hover:bg-[#f2efe8] transition-colors">Lihat Semua Produk</a>
            </div>
        @else
                ...
                @if($products->isNotEmpty())
                    <div>
                        <h2 class="text-lg font-serif tracking-widest uppercase text-[#1c1c1a] mb-8 pb-3 border-b border-[#e5e2de] flex justify-between items-end">
                            ...
                            <a href="{{ url('/shop?search=' . urlencode($q)) }}" class="text-[10px] font-mono tracking-widest text-[#064e3b] hover:underline uppercase">Lihat di Katalog &rarr;</a>
                        </h2>
                ...
                @if($posts->isNotEmpty())
                    <div>
                        <h2 class="text-lg font-serif tracking-widest uppercase text-[#1c1c1a] mb-8 pb-3 border-b border-[#e5e2de] flex justify-between items-end">
                            ...
                            <a href="{{ url('/blog') }}" class="text-[10px] font-mono tracking-widest text-[#064e3b] hover:underline uppercase">Buka Blog &rarr;</a>
                        </h2>
