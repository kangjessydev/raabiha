<div>
    ...
    <div class="page-slide-in">
        ...
        .customer-account-content button,
        .customer-account-content a.inline-block,
        .customer-account-content input[type="text"],
        .customer-account-content input[type="email"],
        .customer-account-content input[type="password"] {
        ...
        .customer-account-content .py-3\.5 { padding-top: 14px !important; padding-bottom: 14px !important; }
        .customer-account-content .py-3 { padding-top: 12px !important; padding-bottom: 12px !important; }
        .customer-account-content .py-2\.5 { padding-top: 10px !important; padding-bottom: 10px !important; }
        .customer-account-content .py-2 { padding-top: 8px !important; padding-bottom: 8px !important; }
        
        .customer-account-content .px-8 { padding-left: 32px !important; padding-right: 32px !important; }
        .customer-account-content .px-6 { padding-left: 24px !important; padding-right: 24px !important; }
        .customer-account-content .px-4 { padding-left: 16px !important; padding-right: 16px !important; }
        .customer-account-content .px-3 { padding-left: 12px !important; padding-right: 12px !important; }
                        ...
                        @if(auth()->check() && !auth()->user()->hasVerifiedEmail())
                            <div class="bg-[#ba1a1a]/10 border border-[#ba1a1a]/20 text-[#ba1a1a] p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p class="font-sans text-[13px] font-semibold">Akun Anda belum terverifikasi.</p>
            ...
            <div class="bg-white max-w-md w-full shadow-2xl relative border border-[#e5e2de]">
                <div class="p-6 md:p-8">
                    ...
                    <div class="pt-6 mt-6 flex flex-col sm:flex-row justify-end gap-3 border-t border-[#e5e2de]">
                        <button type="button" wire:click="closeCancelOrderModal" wire:loading.attr="disabled" wire:target="cancelOrder" class="font-mono text-[10px] font-bold tracking-[0.2em] uppercase text-[#615e57] border border-[#e5e2de] px-6 py-3 hover:bg-[#fcf9f5] transition-colors w-full sm:w-auto text-center order-2 sm:order-1 disabled:opacity-50 disabled:cursor-not-allowed">Kembali</button>
                        <button type="button" wire:click="cancelOrder" wire:loading.attr="disabled" wire:target="cancelOrder" class="font-mono text-[10px] font-bold tracking-[0.2em] uppercase text-white bg-red-600 px-6 py-3 hover:bg-red-700 transition-colors w-full sm:w-auto text-center order-1 sm:order-2 flex justify-center items-center gap-2 disabled:opacity-75 disabled:cursor-not-allowed min-w-[120px]">
