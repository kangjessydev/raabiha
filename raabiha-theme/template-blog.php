...
<main class="site-main bg-[#fcf9f5] min-h-screen pb-0">
    ...
    <section class="max-w-[1440px] mx-auto px-6 lg:px-12 py-8 md:py-12">
        <a href="<?php echo esc_url( home_url('/blog-detail') ); ?>" class="block relative w-full aspect-[4/3] md:aspect-[21/9] overflow-hidden group">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog-hero.png" alt="Featured Article" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
            ...
            <div class="absolute inset-0 p-8 md:p-16 flex flex-col justify-end max-w-3xl">
                ...
                <h1 class="text-3xl md:text-5xl lg:text-6xl font-serif text-white mb-6 leading-tight">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-x-20 md:gap-y-32">
            ...
            <div class="space-y-16 md:space-y-32">
                ...
                <article class="group cursor-pointer">
                    <a href="<?php echo esc_url( home_url('/blog-detail') ); ?>" class="block">
                        <div class="w-full aspect-[4/5] overflow-hidden mb-6">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/gallery-3.png" alt="Silk Texture" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                        </div>
                        <p class="text-[#615e57] text-[9px] font-mono tracking-[0.2em] uppercase mb-3">Atelier & Craft</p>
                        <h3 class="text-2xl md:text-3xl font-serif text-[#1c1c1a] mb-4 group-hover:text-[#064e3b] transition-colors">Precision in Pattern Making: The Structural Sleeve</h3>
                        <p class="text-[#615e57] text-sm leading-relaxed mb-6">
                ...
                <article class="group cursor-pointer">
                    <a href="<?php echo esc_url( home_url('/blog-detail') ); ?>" class="block">
                        ...
                        <h3 class="text-2xl md:text-3xl font-serif text-[#1c1c1a] mb-4 group-hover:text-[#064e3b] transition-colors">The Art of Visual Layering</h3>
                        <p class="text-[#615e57] text-sm leading-relaxed mb-6">
            ...
            <div class="space-y-16 md:space-y-32 md:pt-32">
                ...
                <article class="group cursor-pointer">
                    <a href="<?php echo esc_url( home_url('/blog-detail') ); ?>" class="block">
                        <div class="w-full aspect-[4/5] overflow-hidden mb-6">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/gallery-2.png" alt="White Architecture" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                        </div>
                        <p class="text-[#615e57] text-[9px] font-mono tracking-[0.2em] uppercase mb-3">Architecture</p>
                        <h3 class="text-2xl md:text-3xl font-serif text-[#1c1c1a] mb-4 group-hover:text-[#064e3b] transition-colors">Brutalist Spaces and the Point of Design</h3>
                        <p class="text-[#615e57] text-sm leading-relaxed mb-6">
                ...
                <article class="group cursor-pointer">
                    <a href="<?php echo esc_url( home_url('/blog-detail') ); ?>" class="block">
                        <div class="w-full aspect-square overflow-hidden mb-6 bg-[#f0ede9]">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog-objects.png" alt="Green objects on desk" class="w-full h-full object-cover mix-blend-multiply group-hover:scale-105 transition-transform duration-700">
                        </div>
                        <p class="text-[#615e57] text-[9px] font-mono tracking-[0.2em] uppercase mb-3">Behind the Scenes</p>
                        <h3 class="text-2xl md:text-3xl font-serif text-[#1c1c1a] mb-4 group-hover:text-[#064e3b] transition-colors">Behind the Bespoke: Our Fitting Process</h3>
                        <p class="text-[#615e57] text-sm leading-relaxed mb-6">
    ...
    <!-- Newsletter Banner -->
    <section class="bg-[#f0ede9] py-24 md:py-32 border-t border-[#e5e2de] text-center px-6">
        <p class="text-[#615e57] text-[10px] font-mono tracking-[0.3em] uppercase mb-4">Newsletter</p>
        <h2 class="text-4xl md:text-5xl font-serif text-[#1c1c1a] mb-6">JOIN THE DIALOGUE</h2>
        <p class="text-[#615e57] text-sm max-w-md mx-auto mb-10">
            Dapatkan pembaruan langsung tentang esai desain terbaru, peluncuran koleksi, dan wawasan industri eksklusif dari Raabiha.
        </p>
        <form class="max-w-md mx-auto flex">
            <input type="email" placeholder="YOUR EMAIL" class="flex-1 bg-white border border-[#e5e2de] border-r-0 px-6 py-4 text-[11px] font-mono tracking-widest text-[#1c1c1a] focus:outline-none focus:border-[#064e3b]">
            <button type="button" class="bg-[#1c1c1a] text-white px-8 py-4 text-[11px] font-mono tracking-widest uppercase hover:bg-[#064e3b] transition-colors">Subscribe</button>
        </form>
    </section>
