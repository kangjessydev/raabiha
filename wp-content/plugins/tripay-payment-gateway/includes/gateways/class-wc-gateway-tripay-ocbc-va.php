...
class WC_Gateway_Tripay_OCBC_VA extends Tripay_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        if ($this->settings['enable_icon'] == 'yes') {
            $this->icon = !empty($this->settings['custom_icon']) ? esc_url($this->settings['custom_icon']) : esc_url(plugins_url('/assets/ocbc-va.png', dirname(__FILE__)));
        }
    }
    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            ...
            'enable_icon' => [
                ...
                'type' => 'checkbox',
                'description' => '<img src="'.esc_url(plugins_url('/assets/ocbc-va.png', dirname(__FILE__))).'" style="height:100%;max-height:40px !important" />',
                'default' => 'no',
            ],
            'custom_icon' => [
